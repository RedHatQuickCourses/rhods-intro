...
This introductory course has a few, simple hands-on labs. Provision your own Red Hat OpenShift AI cluster using the Red Hat Hybrid Cloud Console at https://console.redhat.com/application-services/data-science. For a simple, no-cost access to an Red Hat OpenShift AI instance useful for experimentation, click on the "Try it in the sandbox" link and follow the on-screen instructions.
