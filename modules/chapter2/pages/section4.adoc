...
3. Verify the connection of the workench in `intro-projects-a`.
...
5. Verify the variable injected in the workench in `intro-projects-b`.
...
b. Click btn:[Add user] and enter `user-4` as the user name.
Verify that the btn:[Permission selector] is set to btn:[Edit] and click the btn:[✓] button.
